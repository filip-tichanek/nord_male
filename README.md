...
### Introduction
This Repository shows R code and source data used in the publication '[Long-Term Periodic and Conditional Survival Trends in Prostate, Testicular, and Penile Cancers in the Nordic Countries, Marking Timing of Improvements](https://doi.org/10.3390/cancers15174261)', published in the [Cancers](https://www.mdpi.com/journal/cancers) journal.
...
Please, cite the [original article](https://doi.org/10.3390/cancers15174261) when using this R code
