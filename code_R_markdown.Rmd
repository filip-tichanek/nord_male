...
```{r, fig.height=7,fig.width=9, fig.cap="Incidence and Mortality in male cancers"}
# Plotting - incidence -------------------------
...
lines(smoothingSpline,col=cola[xx],lty=xx,lwd=2,lend=1)
...
repeat{
  smoothingSpline = smooth.spline(data$year, data[,xx], spar=spar, nknots=knot)
  lines(smoothingSpline,col=cola[xx-4],lty=xx-4,lwd=2,lend=1)
...
xx=1;yy=range[1]+scal*0.85
rect(1996,yy+0.035*scal,2019,yy-0.21*scal,col="white",border="grey50",lwd=0.8)
repeat{
  lines(c(1997,2004),c(yy,yy),lwd=2,col=cola[xx],lend=1, lty=xx)
...
alpha=1
cola<-c(
  rgb(0.7,0.7,0.1,alpha=alpha),
  rgb(0.4,0,0,alpha=alpha),
  rgb(0 ,0.2,1,alpha=alpha),
  rgb(0, 0.6, 0.3,alpha=alpha)
  )
cola <- cola[c(3,2,1,4)]

alpha=0.2
colb<-c(
  rgb(0.8,0.7,0.1,alpha=alpha),
  rgb(0.4,0,0,alpha=alpha),
  rgb(0 ,0.2,1,alpha=alpha),
  rgb(0, 0.6, 0.3,alpha=alpha)
  )
